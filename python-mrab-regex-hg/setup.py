...
PKG_BASE = 'regex_%i/Python' % MAJOR
EXT_BASE = 'regex_%i/regex' % MAJOR
...
setup(
    ...
    ext_modules=[Extension('_regex', [os.path.join(EXT_BASE, '_regex.c'), os.path.join(EXT_BASE, '_regex_unicode.c')])],
    )
